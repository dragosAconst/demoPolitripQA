...
public class PasswordOnlyNumbersMessageTest extends AbstractChromeWebDriverTest{

    @Test
    public void testPasswordOnlyNumbersMessage(){
        ...
        WebElement errorElement = driver.findElement(By.xpath("//*[@id=\"sign-up-password-div\"]/app-form-control-error-message/em"));
